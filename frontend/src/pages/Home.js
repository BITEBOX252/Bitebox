...
const Home = () => {
  ...
  useEffect(() => {
    axios.get('ec2-56-228-5-252.eu-north-1.compute.amazonaws.com/api/store/categories/')
      .then(response => {
  ...
  useEffect(() => {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(async (position) => {
        ...
        axios.get('ec2-56-228-5-252.eu-north-1.compute.amazonaws.com/api/restaurant/nearby-restaurants/', {
          headers: {
       ...
       <div key={index} className="col-lg-4 col-md-12 mb-4">
         <div className="card">
           ...
           >
            <Link to={`/detail/${r.id}`}>
             <img
               src={`ec2-56-228-5-252.eu-north-1.compute.amazonaws.com${r.image}`}
               className="w-100"
             />
             </Link>
             <a href="#!">
