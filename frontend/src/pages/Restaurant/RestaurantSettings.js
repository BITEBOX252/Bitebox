...
function RestaurantSettings() {
    ...
    const [profileData, setProfileData] = useState([]);
      ...
      const fetchProfileData = async () => {
        if (data?.id) {
          ...
          try {
              axios.get(`http://ec2-13-49-75-56.eu-north-1.compute.amazonaws.com/api/restaurant/profile-update/${data?.id}/`).then((res) => {
      ...
      const fetchRestaurantData = async () => {
        if (data?.id) {
          ...
          try {
              axios.get(`http://ec2-13-49-75-56.eu-north-1.compute.amazonaws.com/api/restaurant/settings-update/${data?.restaurant_id}/`).then((res) => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        if (data?.id) {
          ...
          const res = await  axios.get(`http://ec2-13-49-75-56.eu-north-1.compute.amazonaws.com/api/restaurant/profile-update/${data.id}/`);
        ...
        // formData.append('address', profileData.address);
          ...
          try {
            axios.patch(`http://ec2-13-49-75-56.eu-north-1.compute.amazonaws.com/api/restaurant/profile-update/${data.id}/`, formData, {
              headers: {
      ...
      const handleRestaurantFormSubmit = async (e) => {
        ...
        const res = await  axios.get(`http://ec2-13-49-75-56.eu-north-1.compute.amazonaws.com/api/restaurant/settings-update/${data?.restaurant_id}/`);
        ...
        try {
          axios.patch(`http://ec2-13-49-75-56.eu-north-1.compute.amazonaws.com/api/restaurant/settings-update/${data?.restaurant_id}/`, formData, {
            headers: {
              'Content-Type': 'multipart/form-data'
            },
          });
