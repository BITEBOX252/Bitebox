...
function Cart() {
  ...
  const fetchCartData = (cart_id, user_id) => {
    const url = user_id ? `ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/store/cart-list/${cart_id}/${user_id}/` : `ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/store/cart-list/${cart_id}/`;
    axios.get(url)
      .then((res) => {
        console.log(res);
        setCart(res?.data);
  ...
  const fetchCartTotalData = (cart_id, user_id) => {
    const url = user_id ? `ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/store/cart-detail/${cart_id}/${user_id}/` : `ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/store/cart-detail/${cart_id}/`;
    axios.get(url)
      .then((res) => {
        console.log(res);
...
const updateCart= async(dish_id,price,portion,spice)=>{
  ...
  const formdata=new FormData()
        ...
        const response= await axios.post(`ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/store/cart/`,formdata)
...
const handleDeleteCartItem= async (itemId)=>{
  const url=data?.id 
  ? `ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/store/cart-delete/${CartId}/${data?.id}/${itemId}/`
  :`ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/store/cart-delete/${CartId}/${itemId}/`
  await axios.delete(url)
  // const url1 = data ? `ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/store/cart-list/${CartId}/${data.id}/` : `ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/store/cart-list/${CartId}/`;
...
const createCartOrder = async () => {
        ...
        try {
            ...
            const response = await axios.post('ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/store/create-order/', formData)
