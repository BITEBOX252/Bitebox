  ...
  useEffect(() => {
    const fetEarningStats = async () => {
        if (data?.restaurant_id) {
            ...
            axios.get(`http://127.0.0.1:8000/api/restaurant/earnings/${data?.restaurant_id}/`).then((res) => {
              setEarningStats(res.data[0])
              console.log(res.data);
              
            })
            
            axios.get(`http://127.0.0.1:8000/api/restaurant/monthly-earnings/${data?.restaurant_id}/`).then((res) => {
                console.log(res.data);
