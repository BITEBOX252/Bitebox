...
function ReviewDetail() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/restaurant/reviews/${data?.restaurant_id}/${params.review_id}/`)
    ...
    const handleReplySubmit = async (e) => {
        ...
        await axios.patch(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/restaurant/reviews/${data?.restaurant_id}/${params.review_id}/`, formdata).then((res) => {
