...
function Checkout() {
  ...
  useEffect(() => {
      axios.get(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/store/checkout/${param?.order_oid}/`).then((res) => {
        setOrder(res.data);
              ...
              <div className="row gx-lg-5">
                ...
                <div className="col-lg-4 mb-4 mb-md-0">
                  ...
                  <section className="shadow-4 p-4 rounded-5 mb-4">
                    ...
                    <form
                      action={`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/stripe-checkout/ORDER_ID/`}
                      method="POST"
                    >
                      <button
                        type="submit"
