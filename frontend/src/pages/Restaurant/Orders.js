...
function Orders() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            if (data?.restaurant_id) {
                try {
                    const response = await axios.get(`ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/restaurant/orders/${data.restaurant_id}/`);
  ...
  <select
    ...
    onChange={async (e) => {
      ...
      try {
        await axios.patch(`ec2-51-20-114-152.eu-north-1.compute.amazonaws.com/api/restaurant/orders/${data.restaurant_id}/${o.oid}/`, {
