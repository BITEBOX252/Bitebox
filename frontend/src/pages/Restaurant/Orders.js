...
function Orders() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            if (data?.restaurant_id) {
                try {
                    const response = await axios.get(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/restaurant/orders/${data.restaurant_id}/`);
  ...
  <select
    ...
    onChange={async (e) => {
      ...
      try {
        await axios.patch(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/restaurant/orders/${data.restaurant_id}/${o.oid}/`, {
