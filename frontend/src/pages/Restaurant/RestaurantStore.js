...
function RestaurantStore() {
    ...
    useEffect(() => {
        axios.get(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/restaurant/shop/${param.slug}/`).then((res)=>{
            setRestaurant(res.data)
            console.log(res.data)
        })
        axios.get(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/restaurant/dishes-store/${param.slug}/`).then((res)=>{
            console.log(res.data)
            setDish(res.data)
        })
