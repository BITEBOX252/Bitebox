...
const DishDetail = () => {
    ...
    useEffect(()=>  {
        ...
        axios.get(`ec2-56-228-5-252.eu-north-1.compute.amazonaws.com/api/store/dish/${params.slug}`).then((res)=>{
    ...
    const portionSizeHandler= async (e)=>{
        ...
        try {
            ...
            const response = await axios.get(`ec2-56-228-5-252.eu-north-1.compute.amazonaws.com/api/store/dish/${params.slug}`, {
    ...
    const fetchReviewData = async () => {
        try {
            const res = await axios.get(`ec2-56-228-5-252.eu-north-1.compute.amazonaws.com/api/restaurant/reviews/${dishes?.id}`);
            setReviews(res.data);
            console.log(res.data);
        } catch (error) {
...
const handleReviewSubmit=(e)=>{
    ...
    axios.post(`ec2-56-228-5-252.eu-north-1.compute.amazonaws.com/api/restaurant/reviews/${dishes?.id}/`,formData).then((res)=>{
        console.log(res.data);
        fetchReviewData()
        Toast.fire({
            icon: 'success',
