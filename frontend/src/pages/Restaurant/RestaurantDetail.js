...
//     axios.get(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/store/dishes/`, {
...
//           axios.get(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/store/dish/${dishes?.slug}`).then((res)=>{
...
const RestaurantDetail = () => {
  ...
  useEffect(() => {
    ...
    if (dishes.length > 0) {
      ...
      axios.get(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/store/dish/${slug}`)
        .then(response => {
