...
function UpdateDish() {
    ...
    useEffect(()=>{
        axios.get(`ec2-56-228-5-252.eu-north-1.compute.amazonaws.com/api/restaurant/update-dish/${userdata?.restaurant_id}/${param.did}/`).then((res)=>{
            console.log(res.data);
            setDish(res.data)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.patch(`ec2-56-228-5-252.eu-north-1.compute.amazonaws.com/api/restaurant/update-dish/${userdata?.restaurant_id}/${param.did}/`, formData, {
                headers: {
