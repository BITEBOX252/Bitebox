...
function RestaurantDashboard() {
  ...
  useEffect(() => {
    ...
    if (data?.restaurant_id) {  // ✅ Ensure restaurant_id exists before making API call
      axios.get(`ec2-56-228-5-252.eu-north-1.compute.amazonaws.com/api/restaurant/stats/${data.restaurant_id}/`)
        .then((res) => {
  ...
  // useEffect(()=>{
  //   console.log(data)
  //   axios.get(`ec2-56-228-5-252.eu-north-1.compute.amazonaws.com/api/restaurant/stats/${data?.restaurant_id}/`).then((res)=>{
  //     console.log(res)
  //     setStats(res.data)
  //   })
  // },[])
