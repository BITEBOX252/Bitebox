    ...
    const handleSubmit = async (e) => {
      ...
      if (dish.title == "" || dish.description == "" || dish.price == "" || dish.category === null || dish.stock_qty == "" || dish.image === null) {
          ...
          Swal.fire({
              ...
              text: "All fields are required to create a dish",
          })
          return;
      }
      ...
      try {
          ...
          const response = await axios.post(`http://ec2-13-49-75-56.eu-north-1.compute.amazonaws.com/api/restaurant/create-dish/${userdata?.restaurant_id}/`, formData, {
              headers: {
          ...
          Swal.fire({
              ...
              text: 'This Dish has been successfully created',
          });
