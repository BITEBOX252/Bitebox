...
function Notifications() {
  ...
  const fetchNoti = async () => {
    if (data?.restaurant_id) {
      ...
      try {
        const response = await axios.get(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/restaurant/notifications/${data?.restaurant_id}/`);
  ...
  const fetchNotiSummary = async () => {
    if (data?.restaurant_id) {
      ...
      try {
        const response = await axios.get(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/restaurant/notifications-summary/${data?.restaurant_id}/`);
  ...
  const handleNotificationSeenStatus = async (notiId) => {
      ...
      try {
        const response = await axios.get(`http://ec2-13-48-47-13.eu-north-1.compute.amazonaws.com/api/restaurant/notifications-mark-as-seen/${data?.restaurant_id}/${notiId}/`);
        console.log(response.data);
        await fetchNoti()
