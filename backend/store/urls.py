...
from .views import CategoryListAPIView,DishListAPIView,DishDetailAPIView,CartAPIView,CartLisAPItView,CartDetailAPIView,CartDeleteAPIView,createOrderAPIView,checkoutAPIView
urlpatterns = [
